...
Это пошаговая инструкция по сборке робота-машинки, который способен выполнять голосовые команды благодаря специальному модулю голосового управления с искусственным интеллектом, который распознаёт команды на русском языке. В инструкции подробно рассказано, как собрать и запрограммировать такого робота.
...
3. [Сборка логической части робота](#3-Сборка-логической-части-робота)
   - [Подгтовка инструментов и деталей](#31-Подгтовка-инструментов-и-деталей)
